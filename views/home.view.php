...
<div class="aside">
    ...
    <div class="content">
        <a href="" class="a-block large-btn">
            <div class="left">
                <div class="show">
                    <div class="frame">
                        <p class="body">10</p>
        ...
        <div class="form-container">
            ...
            <form action="" method="POST" class="add-form" invalidate>
                <div class="heading">
                    ...
                    <div class="buttons">
                        <div class="button icon light-border">
                ...
                <div class="inputs">
                    <div class="type-inputs">
                        <input type="text" name="title" placeholder="Your idea">
                        <textarea name="description" placeholder="Describe your idea" oninput='this.style.height = "";this.style.height = this.scrollHeight + "px"'></textarea>
                    </div>
                    <input type="submit" value="Add the idea">
                </div>
            </form>
        </div>
    </div>
...
<div class="main-content">
    <div class="company-profile">
        ...
        <div class="buttons">
            ...
            <!-- <a href="" class="a-block button icon">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="" class="a-block button icon fill">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
